...
(function (window, factory) {
    ...
    function iframeHandler(target) {
        ...
        if (matches) {
            url = appendQueryParams('https://www.youtube' + (matches[2] || '') + '.com/embed/' + matches[4], $.extend({
                autoplay: 1
        ...
        if (matches) {
            url = appendQueryParams('https://player.vimeo.com/video/' + matches[3], $.extend({
                autoplay: 1
        ...
        if (matches) {
            url = appendQueryParams('https://www.google.' + matches[3] + '/maps?' + matches[6], {
    ...
    function lity(options) {
        ...
        function resize() {
            ...
            _content.css('max-height', Math.floor(height) + 'px').trigger('lity:resize', [_instance]);
        }
        ...
        function ready(el, content) {
            ...
            _content.removeClass('lity-hide').trigger('lity:ready', [_instance, el]);
        ...
        function open(target, options, el) {
            ...
            options = $.extend({}, _defaultOptions, _options, options);
